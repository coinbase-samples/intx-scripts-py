...
if len(sys.argv) < 3:
    sys.exit('Usage: intx_cancel_orders.py <portfolio> <instrument>')

portfolio = sys.argv[1]
instrument = sys.argv[2]

url = f'https://api.international.coinbase.com/api/v1/orders?portfolio={portfolio}&instrument={instrument}'
