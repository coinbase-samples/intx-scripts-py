...
import json, hmac, hashlib, time, requests, base64, sys, os
from urllib.parse import urlparse

if len(sys.argv) < 2:
    sys.exit('Usage: intx_get_instrument_quote.py <instrument>')

instrument = sys.argv[1]

url = f'https://api.international.coinbase.com/api/v1/instruments/{instrument}/quote'
